...
\begin{definition}{\textbf{(Adjoint, symmetric, and self-adjoint operators)}}
      ...
      \index{operator!adjoint}\index{operator!symmetric}\index{operator!self-adjoint}
\begin{itemize}
...
one-dimensional Sturm-Liouville operator\index{operator!Sturm-Liouville},
...
The Ritz-Galerkin method\index{Ritz-Galerkin method} then involves approximating
...
matrices; \index{matrix!Ritz} in general, a wide variety of boundary value
...
\cite{pryce1993numerical}:\index{operator!Schr\"odinger}
