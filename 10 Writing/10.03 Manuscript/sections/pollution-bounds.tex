...
The gateway to bounding the spectrum (and its pollution) of an operator $T$ on a Hilbert space lies in a function known as the \textbf{Rayleigh quotient}\index{Rayleigh quotient}, $R_T: \Dom(T) \rightarrow \mathbb{C}$, defined:
