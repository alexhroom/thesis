...
\textbf{approximate point spectrum}\index{spectrum!approximate point}, denoted
$\Spec_{ap}$:
...
\label{thm:num-range-props}
  ...
  \begin{enumerate}
    ...
    \index{theorem!Toeplitz-Hausdorff}
...
\textbf{semibounded}\index{operator!semibounded} operators, which are operators
...
\index{range!essential numerical}
